<?php
class Ant_Api_Model_Api2_Order extends Mage_Api2_Model_Resource{
    public function dispatch()
    {
        switch ($this->getActionType() . $this->getOperation()) {
            ...
            case self::ACTION_TYPE_ENTITY . self::OPERATION_UPDATE:
                ...
                $arrayOrder = Mage::helper("ant_api")->setTheHashOrder($order);
                //$this->getResponse()->setHeader('Location', $newItemLocation);
                //$this->getResponse()->setHttpResponseCode(200);
                $this->getResponse()->clearHeaders()->setHeader('Content-type','application/json',true);
                $this->getResponse()->setBody(json_encode($arrayOrder));
                break;
