 ...
 */
class Ant_Api_Block_Adminhtml_System_Config_Form_Field_Module_Version extends Mage_Adminhtml_Block_System_Config_Form_Field
{

    public function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        return Mage::helper('ant_api')->getModuleVersion();
    }
